...
import { Plane, Hash, ListOrdered, Edit } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
import { BusinessTravelSetting } from '../types/business-travel-setting.types';

export interface BusinessTravelSettingViewModalProps {
  open: boolean;
...
export function BusinessTravelSettingViewModal({
  open,
  onOpenChange,
  setting,
  loading = false,
  locale,
  onEdit,
}: BusinessTravelSettingViewModalProps) {
